<?php
/**
 * thanos functions and definitions
 *
 ...
 */
function thanos_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'thanos' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'thanos' ),
...
add_action( 'widgets_init', 'thanos_widgets_init' );
...
function thanos_scripts() {
	...
	wp_enqueue_script( 'thanos-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'thanos-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
