...
mapboxgl.accessToken = 'pk.eyJ1IjoibGlua2ViaW4iLCJhIjoiY2szbzcxNGIzMDVwdTNibXV6MWV6MXgxeiJ9.SU_Tmcud24UTRnCFDIJJVw'; //Initialisation de la map
...
map.on('load', function () {
  map.loadImage('wp-content/themes/thanos/assets/img/6774888_preview.png.jpeg', function (error, image) {
    ...
    map.addImage('poubelle', image); // Add a new source from our GeoJSON data and set the
  ...
  map.on('click', 'unclustered-point', function (e) {
    ...
    console.log(commune);
    console.log(type);
    new mapboxgl.Popup().setLngLat(coordinates).setHTML(adresse + '<p><strong>' + commune + '</strong></p>' + '<p>' + type + '</p>').addTo(map);
  });
